...
import com.example.service.MediaThreadManager;
...
public class SWTMediaPlayer {
	...
	private static MediaThreadManager mediaThreadManager;
    ...
    public static void open(String filePath) {
        ...
        //mediaThreadManager=new MediaThreadManager(mediaPlayer);
...
//		}).start();
		...
		MediaThreadManager.excute(thread);
